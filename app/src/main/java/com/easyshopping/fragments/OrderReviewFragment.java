...
import com.easyshopping.databinding.FragmentOrderReviewBinding;
...
public class OrderReviewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.layoutMyProfile.tvHeader.setText(R.string.order_review);

        binding.btnCheckout.setOnClickListener(v ->
                {
                    Navigation.findNavController(v).navigate(R.id.action_orderReviewFragment_to_shipToFragment);
